...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   POST: () => (/* binding */ POST)\n/* harmony export */ });\n/* harmony import */ var _google_genai__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @google/genai */ \"(rsc)/./node_modules/@google/genai/dist/node/index.mjs\");\n\nasync function POST(req) {\n    try {\n        const { smoking, drinking } = await req.json();\n        const ai = new _google_genai__WEBPACK_IMPORTED_MODULE_0__.GoogleGenAI({\n            apiKey: process.env.GEMINI_API_KEY\n        });\n        const MODEL_PRIMARY = \"gemini-2.5-flash\";\n        const MODEL_FALLBACK = \"gemini-1.5-flash\";\n        const prompt = `\nAs a health AI, provide a brief (2-3 sentences) insight for a patient with:\n- Smoking risk: ${(smoking * 100).toFixed(1)}%\n- Drinking risk: ${(drinking * 100).toFixed(1)}%\n\nBe encouraging, professional, and natural.\nAvoid repetition and give meaningful interpretation.\n`;\n        let response;\n        try {\n            response = await ai.models.generateContent({\n                model: MODEL_PRIMARY,\n                contents: prompt,\n                config: {\n                    temperature: 0.9,\n                    topP: 0.95,\n                    topK: 64\n                }\n            });\n        } catch (primaryError) {\n            console.warn(\"Primary model failed, switching fallback...\");\n            response = await ai.models.generateContent({\n                model: MODEL_FALLBACK,\n                contents: prompt,\n                config: {\n                    temperature: 0.9,\n                    topP: 0.95,\n                    topK: 64\n                }\n            });\n        }\n        return Response.json({\n            text: response.text || \"No insight generated\"\n        });\n    } catch (error) {\n        console.error(\"INSIGHT API ERROR:\", error);\n        return new Response(JSON.stringify({\n            error: \"AI temporarily unavailable. Please try again.\"\n        }), {\n            status: 500,\n            headers: {\n                \"Content-Type\": \"application/json\"\n            }\n        });\n    }\n}\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(rsc)/./app/api/insights/route.ts\n");

/***/ }),

/***/ "(rsc)/./node_modules/next/dist/build/webpack/loaders/next-app-loader/index.js?name=app%2Fapi%2Finsights%2Froute&page=%2Fapi%2Finsights%2Froute&appPaths=&pagePath=private-next-app-dir%2Fapi%2Finsights%2Froute.ts&appDir=C%3A%5Cxampp%5Chtdocs%5CSmokes-DrinksAI%5Capp&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&rootDir=C%3A%5Cxampp%5Chtdocs%5CSmokes-DrinksAI&isDev=true&tsconfigPath=tsconfig.json&basePath=&assetPrefix=&nextConfigOutput=export&preferredRegion=&middlewareConfig=e30%3D&isGlobalNotFoundEnabled=!":
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
